...
//                               + 2.0 * cos(8.0 * i * PI / 180.0);
                ...
                if (!std::isnan(signalAndNoise)) {
                    ...
                    double signalEval = df.updateFilterWeightsByLeastSquaresAlgorithm(signalAndNoise, noiseEval);
        ...
        void test_build_tree() {
            ...
            ml::decisiontree::DecisionTree<MyItem> tree(&matcher);
            utils::CArrayList<MyItem> items;
