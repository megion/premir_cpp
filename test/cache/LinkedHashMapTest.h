...
class TestEntryComparator : public cache::LinkedHashMap<
                                test_entry, test_entry_data>::EntryComparator {
    public:
    bool equals(const test_entry* entry, unsigned int keyHash,
                const test_entry_data* keyData) const
    {
